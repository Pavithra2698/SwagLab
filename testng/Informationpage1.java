...
public class Informationpage1 extends Baseclass {
	...
	private void Tc_005() throws IOException {
		obj=new Pom_Informationpage(driver);//
		String data_Pass = data_Pass("info testcase", 21, 5);
		sendkeys(obj.getFirstname(), data_Pass);
		String data_Pass2 = data_Pass("info testcase", 22, 5);
		sendkeys(obj.getLastname(), data_Pass2);
		click(obj.getCaryon());
		Screenshot("Info_ID1-datapass1");
	}
	...
	private void Tc_007() throws IOException {
		obj=new Pom_Informationpage(driver);//
		String data_Pass = data_Pass("info testcase", 30, 5);
		sendkeys(obj.getLastname(), data_Pass);
		String data_Pass2 = data_Pass("info testcase", 31, 5);
		sendkeys(obj.getPostal(), data_Pass2);
		click(obj.getCaryon());
		Screenshot("Info_ID1-datapass2");
	}
